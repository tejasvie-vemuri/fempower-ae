...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.member_milestones TO authenticated;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.member_spotlights TO authenticated;
GRANT ALL ON public.member_spotlights TO service_role;
