...
-- 7. Private storage bucket policies.
-- The bucket itself was created via the Storage API because SQL INSERT INTO
-- storage.buckets is rejected by the migration tool. The policies below match
-- the original migration file exactly.
