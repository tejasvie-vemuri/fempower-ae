...
CREATE POLICY "Admins can insert courses"
  ON public.learn_courses FOR INSERT TO authenticated
  WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can update courses"
  ON public.learn_courses FOR UPDATE TO authenticated
  USING (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can delete courses"
  ON public.learn_courses FOR DELETE TO authenticated
  USING (public.has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Admins can insert modules"
  ON public.learn_modules FOR INSERT TO authenticated
  WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can update modules"
  ON public.learn_modules FOR UPDATE TO authenticated
  USING (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can delete modules"
  ON public.learn_modules FOR DELETE TO authenticated
  USING (public.has_role(auth.uid(), 'admin'));
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.learn_wings TO authenticated;
GRANT ALL ON public.learn_wings TO service_role;
ALTER TABLE public.learn_wings ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Authenticated users can view wings"
  ON public.learn_wings FOR SELECT TO authenticated
  USING (auth.uid() IS NOT NULL);
CREATE POLICY "Admins can insert wings"
  ON public.learn_wings FOR INSERT TO authenticated
  WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can update wings"
  ON public.learn_wings FOR UPDATE TO authenticated
  USING (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can delete wings"
  ON public.learn_wings FOR DELETE TO authenticated
  USING (public.has_role(auth.uid(), 'admin'));
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.learn_resources TO authenticated;
GRANT ALL ON public.learn_resources TO service_role;
ALTER TABLE public.learn_resources ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Authenticated users can view resources"
  ON public.learn_resources FOR SELECT TO authenticated
  USING (auth.uid() IS NOT NULL);
CREATE POLICY "Admins can insert resources"
  ON public.learn_resources FOR INSERT TO authenticated
  WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can update resources"
  ON public.learn_resources FOR UPDATE TO authenticated
  USING (public.has_role(auth.uid(), 'admin'));
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.learn_reflections TO authenticated;
GRANT ALL ON public.learn_reflections TO service_role;
ALTER TABLE public.learn_reflections ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Users can view own reflections"
  ON public.learn_reflections FOR SELECT TO authenticated
  USING (auth.uid() = user_id);
CREATE POLICY "Users can view shared reflections"
  ON public.learn_reflections FOR SELECT TO authenticated
  USING (is_shared = true AND auth.uid() IS NOT NULL);
CREATE POLICY "Users can insert own reflections"
  ON public.learn_reflections FOR INSERT TO authenticated
  WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own reflections"
  ON public.learn_reflections FOR UPDATE TO authenticated
  USING (auth.uid() = user_id);
CREATE POLICY "Users can delete own reflections"
  ON public.learn_reflections FOR DELETE TO authenticated
  USING (auth.uid() = user_id);
