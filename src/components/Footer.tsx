  ...
  <footer className="border-t border-border">
    ...
    <div className="container flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div className="flex items-center gap-5">
        <a href="https://www.instagram.com/fempower.ae" target="_blank" rel="noopener noreferrer" aria-label="Fempower on Instagram" className="text-muted-foreground hover:text-foreground transition-colors">
          <Instagram size={20} />
        </a>
        ...
        <a href="mailto:hello@fempower.ae" className="text-xs text-muted-foreground hover:text-foreground font-body uppercase tracking-widest transition-colors">
          hello@fempower.ae
        </a>
      </div>
