          ...
          <div className="relative">
            ...
            {!isAuthed && (
              <div className="mt-6 rounded-xl bg-blush-light/50 border border-border p-4 text-sm font-body text-foreground flex items-start gap-3">
                <Lock size={16} className="text-blush-dark flex-shrink-0 mt-0.5" />
                <p className="text-muted-foreground">
                  Actual posts and member names stay private. Join Fempower to unlock the
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              >
                <Link to={isAuthed ? "/circle" : "/join"}>
                  {isAuthed ? "Enter the Circle" : "Join to unlock"}
                </Link>
              </Button>
