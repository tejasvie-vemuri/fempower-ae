  ...
  public: {
    Tables: {
      ai_edge_bookmarks: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_edge_bookmarks_prompt_id_fkey"
            columns: ["prompt_id"]
            isOneToOne: false
            referencedRelation: "ai_edge_prompts"
      ...
      ai_edge_prompts: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_edge_prompts_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "ai_edge_categories"
            referencedColumns: ["id"]
          },
        ]
      }
